...
install:
	@tnpm install
	@cd static && npm install --registry=http://registry.anpm.alibaba-inc.com
...
release: clear
	...
	@cd ./out/release && npm install --registry=http://registry.anpm.alibaba-inc.com --force
	@if [ -d ./out/release/static ];then cd ./out/release/static && npm install --registry=http://registry.anpm.alibaba-inc.com --force; fi
	...
	@cp -f ./out/release/node_modules/node-cube/runtime/cube.min.js ./out/release/static.release/cube.js
